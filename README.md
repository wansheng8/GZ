...
[![Rules](https://img.shields.io/badge/Total_Rules-793%2C575-ff00e5?style=for-the-badge&labelColor=0d0d0d)](dist/adblock_collection_full.txt)
[![DNS](https://img.shields.io/badge/DNS_Domains-539%2C765-00f0ff?style=for-the-badge&labelColor=0d0d0d)](dist/adblock_collection_full_dns.txt)
...
<img src="assets/stats.svg" width="100%" alt="793,575 rules · 539,765 domains · 60 sources · 33.8万+ deduplicated"/>
...
| 类型 | 数量 | 归属层 |
| :--- | ---: | :--- |
| network | 629,420 | 网络拦截（DNS 从中提取纯域名） |
| css | 146,131 | 元素隐藏 |
...
| 类别 | 数量 | 订阅 |
| :--- | ---: | :--- |
| network | 480,120 | [订阅](https://raw.githubusercontent.com/wansheng8/GZ/main/dist/adblock_collection_full_network.txt) |
