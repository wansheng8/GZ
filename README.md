...
| 指标 | 数值 | 说明 |
| --- | ---: | --- |
| `FULL RULESET` | **968,349** | 网络 / CSS / 脚本 / HTML 全部类型 |
| `DNS DOMAINS` | **491,021** | 从纯域名网络规则自动提取 |
| `UPSTREAM` | **60** | 全部在线健康（`failed = 0`） |
| `DEDUP` | **33.8 万+** | 去重合并后的唯一规则集 |
