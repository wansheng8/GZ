...
[![Rules](https://img.shields.io/badge/Total_Rules-778%2C407-ff00e5?style=for-the-badge&labelColor=0d0d0d)](dist/adblock_collection_full.txt)
[![DNS](https://img.shields.io/badge/DNS_Domains-539%2C996-00f0ff?style=for-the-badge&labelColor=0d0d0d)](dist/adblock_collection_full_dns.txt)
...
> Surge / Quantumult X 规则集超 20MB，jsDelivr 拆为 `_part01` / `_part02`，需把两份都加入；GitHub 上是完整单文件。
...
<img src="assets/stats.svg" width="100%" alt="778,407 rules · 539,996 domains · 60 sources · 33.8万+ deduplicated"/>
